    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t bg-background/80 backdrop-blur-sm relative z-10">
        ...
        <div className={isHomePage ? "container px-4 md:px-6" : "journal-container"}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8 md:justify-between">
            {/* Website Title and Bio */}
            <div className="space-y-3">
              <h3 className="font-semibold text-xl">Lumen</h3>
            ...
            {/* Legal Pages */}
            <div className="space-y-3">
              <h3 className="font-medium text-sm uppercase tracking-wider text-muted-foreground">Legal</h3>
              <nav className="flex flex-col space-y-2">
                <Link to="/privacy" className="text-sm text-foreground hover:text-primary transition-colors">Privacy Policy</Link>
                <Link to="/terms" className="text-sm text-foreground hover:text-primary transition-colors">Terms of Use</Link>
                <Link to="/cookies" className="text-sm text-foreground hover:text-primary transition-colors">Cookie Policy</Link>
              </nav>
            </div>
            
            {/* Social Media Links */}
            <div className="space-y-3">
              <h3 className="font-medium text-sm uppercase tracking-wider text-muted-foreground">Connect</h3>
